fun main(args: Array<String>) {
    val input = "1224\t926\t1380\t688\t845\t109\t118\t88\t1275\t1306\t91\t796\t102\t1361\t27\t995\n" +
    ...
    for (rowString in rows) {
        val row = rowString.split(Regex("\\s"))
        ...
        for (numString in row) {
            ...
            largest = if (num > largest) num else largest
            smallest = if (num < smallest) num else smallest
        }
